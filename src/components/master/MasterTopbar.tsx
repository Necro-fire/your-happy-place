...
export function MasterTopbar() {
  ...
  return (
    <header
      className="sticky top-0 z-10 flex h-16 items-center gap-2 border-b px-3 backdrop-blur sm:gap-3 sm:px-6 lg:px-8"
      style={{
        borderColor: "var(--ms-border)",
        background: "color-mix(in oklab, var(--ms-surface) 95%, transparent)",
        color: "var(--ms-text)",
      }}
    >
      <MasterMobileNav />
      <div className="relative hidden max-w-md flex-1 md:block">
        ...
        />
        <input placeholder="Buscar empresas, usuários, licenças..." className="ms-input" />
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        >
          <div className="text-[13px] font-medium leading-tight" style={{ color: "var(--ms-text)" }}>
            {now ? now.toLocaleDateString("pt-BR", { day: "2-digit", month: "2-digit", year: "numeric" }) : "--/--/----"}
          </div>
          <div className="text-[11px] leading-tight" style={{ color: "var(--ms-text-muted)" }}>
